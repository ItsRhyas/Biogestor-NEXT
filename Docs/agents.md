...
- **Estilos**: únicamente o importaciones de bootstrap o malterual ui con styled-components.
...
- **Documentación**: Archivos `README.md`, `DOCUMENTACION_API.md`, `GUIA_DESPLIEGUE.md`, `DOCUMENTACION_FRONTEND.md` en backend y frontend.
